defmodule RealDealApiWeb.Auth.Guardian do
  ...
  def resource_from_claims(_resource, _claims), do: {:error, :no_id_provided}
  ...
  def encode_sign(account), do: encode_and_sign(account)

  def validate_password(password, hash_password), do: Bcrypt.verify_pass(password, hash_password)
